...
echo "=== GET test data ==="
curl -X GET -H "x-api-token: secret" -s http://127.0.0.1:9101/target -d '{"id":"b055002b-c13a-56dd-81d0-4030e70b841b"}' | grep 'smartctl'
curl -X GET -H "x-api-token: secret" -s http://127.0.0.1:9101/target -d '{"id":"2ead9294-3095-511f-8d49-a4d972b73fba"}' | grep 'ipmi'
